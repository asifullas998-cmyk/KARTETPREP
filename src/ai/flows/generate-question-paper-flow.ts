...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert KARTET exam tutor. Generate a question paper with 10 important and frequently repeated questions for the given subject. Provide 4 multiple choice options and the correct answer for each question. The entire response must be in the specified language.
